...
public class DogChessUtils {
	...
	private static final String URL_FEN2IMAGE = "![CHESS BOARD](http://www.fen-to-image.com/image/128/double/coords/_FEN_)";
	private static final String URL_FEN2IMAGE_ROTATED = "![CHESS BOARD ROTATED](http://www.fen-to-image.com/image/128/double/_FEN_)";
