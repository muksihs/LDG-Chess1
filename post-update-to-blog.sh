...
echo "tags: utopian-io chess java steemj git-log"  >> "$msgfile"
echo "format: markdown"  >> "$msgfile"
echo "" >> "$msgfile"
echo "<center>![chessboard.png](https://steemitimages.com/0x0/http://www.jinchess.com/chessboard/?p=rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR&tm=w&s=xl&bp=wooden-dark&c=&a=&filename=chessboard.png)</center>" >> "$msgfile"
echo "" >> "$msgfile"
