...
echo "" >> "$msgfile"
echo "![chessboard.png](https://steemitimages.com/0x0/http://www.jinchess.com/chessboard/?p=rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR&tm=w&s=xl&bp=wooden-dark&c=&a=&filename=chessboard.png)" >> "$msgfile"
echo "" >> "$msgfile"
